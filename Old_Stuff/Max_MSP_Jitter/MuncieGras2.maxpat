{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 256.0, 111.0, 1102.0, 821.0 ],
		"bglocked" : 0,
		"defrect" : [ 256.0, 111.0, 1102.0, 821.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 945.0, 330.0, 60.0, 20.0 ],
					"id" : "obj-95",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 660.0, 45.0, 40.0, 20.0 ],
					"id" : "obj-92",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "s whip",
					"fontsize" : 12.0,
					"patching_rect" : [ 435.0, 450.0, 45.0, 20.0 ],
					"id" : "obj-87",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"outlettype" : [ "" ],
					"patching_rect" : [ 759.175293, 689.212402, 79.0, 18.0 ],
					"id" : "obj-65",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"outlettype" : [ "int" ],
					"patching_rect" : [ 759.175293, 666.44043, 20.0, 20.0 ],
					"id" : "obj-67",
					"numinlets" : 1,
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"outlettype" : [ "" ],
					"patching_rect" : [ 694.435974, 689.212402, 62.0, 18.0 ],
					"id" : "obj-75",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"outlettype" : [ "int" ],
					"patching_rect" : [ 694.435974, 666.44043, 20.0, 20.0 ],
					"id" : "obj-81",
					"numinlets" : 1,
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"outlettype" : [ "" ],
					"patching_rect" : [ 842.0, 689.212402, 90.0, 20.0 ],
					"id" : "obj-82",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 660.0, 720.0, 101.0, 20.0 ],
					"id" : "obj-85",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 345.0, 285.0, 60.0, 20.0 ],
					"id" : "obj-106",
					"fontname" : "Arial",
					"numinlets" : 1,
					"types" : [  ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 375.0, 51.0, 18.0 ],
					"id" : "obj-96",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 703.935974, 711.0, 669.5, 711.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-85", 0 ],
					"hidden" : 0,
					"midpoints" : [ 768.675293, 711.0, 669.5, 711.0 ]
				}
